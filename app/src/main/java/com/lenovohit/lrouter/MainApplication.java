...
import com.lenovohit.bussiness_module_a.BusinessModuleServiceConnection;
...
public class MainApplication extends LRouterAppcation {
    ...
    public void regiterLocalRouterService() {//将本地路由服务进行注册进远程路由内
        ...
        RemoteRouter.registerLocalRouterServiceConnection("com.lenovohit.bussiness_module_a:moduleA", BusinessModuleServiceConnection.class);
    }
    ...
    protected void regiterAnologyApplication() {//将类application类注册进Application内
        ...
        registerAnologyApplication("com.lenovohit.bussiness_module_a:moduleA",998, BusinessModuleAnologyApplication.class);
    }
